...
class UserFlowServices
{
    ...
    public function newUserFlow($id, array $data, $token)
    {
        ...
        $form = new \App\Http\Form\FlowForm($data, $flow);
        ...
        foreach ($data as $key => $datum) {
            ...
            $field = \App\Http\Form\FlowForm::makeFlowField($baseForm);
...
//                "version" => config("flow.version", 0),
    ...
    public function buildShowForm($id)
    {
        ...
        $form = new \App\Http\Form\FlowForm($userflow->buildData(), $userflow);
