...
class DFlowTimeout extends Controller
{
    ...
    static public function autoSetFinishFromTimeoutTable(){
        ...
        $list=Config::getmonconn()->sample_get(Config::$mongo_flowtimeoutlogs,['msgid'],$where,$funcallback,'created_at',1);
    ...
    static public function export(){
        ...
        $Curd= new DbCtrlCurdOBJ(static::$DBid,DbCtrlCurdOBJ::$OtherKeysSearch);
        ...
        $backdata= $Curd->search_data(request()->input('currentPage',1),request()->json('search'),$where);
